...
yy389:
    p = marker;
    if (yyaccept == 0) goto yy384;
    else goto yy404;
yy390:
    yych = *++p;
    if (yybm[0+yych] & 128) goto yy390;
    if (yych <= '\n') {
...
yy427:
    yych = *++p;
yy428:
    if (yybm[0+yych] & 64) goto yy427;
    if (yych >= '\v') goto yy430;
yy429:
    p = marker;
    if (yyaccept == 0) goto yy424;
    else goto yy432;
yy430:
    yych = *++p;
...
yy459:
    p = marker;
    if (yyaccept <= 1) {
      if (yyaccept == 0) goto yy453;
      else goto yy461;
    } else {
      if (yyaccept == 2) goto yy466;
      else goto yy471;
    }
yy460:
    ++p;
